...
// ── TELEGRAM GROWTH ENGINE SPOTLIGHT — shared across all render paths ────────
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{
                            ...
                            scrapes &amp; scores leads, then sends personalised 3-step DM sequences —
                            all while you sleep.
                        </p>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.25rem' }}>
                            ...
                            <div style={{
                                flex: 1, background: 'rgba(255,255,255,0.05)', borderRadius: '0.5rem',
                                padding: '0.28rem 0.75rem',
                                color: '#475569', fontSize: '0.7rem', fontFamily: 'monospace',
                            }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '1rem' }}>
                            {[
                                ...
                                <div key={s.label} style={{
                                    ...
                                    borderRadius: '0.875rem', padding: '0.9rem',
                                }}>
    ...
    return (
        <>
            ...
            <main className={styles.main}>
                        ...
                        <div style={{ marginTop: '1.75rem', display: 'flex', justifyContent: 'center' }}>
                            <Link href="/telegram-growth" style={{
                                ...
                                <span style={{ color: '#94a3b8', fontSize: '0.82rem', fontWeight: 500 }}>
                                    New: Telegram Growth Engine — 1,284 leads scraped this week
                                </span>
                                <span style={{
                ...
                {/* ── TELEGRAM GROWTH ENGINE — PRODUCT SPOTLIGHT ──────────────── */}
                <section style={{
                    padding: '5rem 2rem',
                    position: 'relative',
                    overflow: 'hidden',
                    ...
                    <div style={{
                        position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none',
                        background: 'radial-gradient(ellipse 70% 80% at 60% 50%, rgba(34,211,238,0.055) 0%, transparent 70%)',
                    }} />
                    <div style={{ maxWidth: '1180px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                        <div style={{
                            display: 'grid',
                            ...
                            <div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.5rem' }}>
                                    <span style={{
                                        ...
                                        <span style={{ width: 6, height: 6, background: '#10b981', borderRadius: '50%', boxShadow: '0 0 5px #10b981', display: 'inline-block' }} />
                                        New Product · Live Now
                                    </span>
                                </div>
                                ...
                                <p style={{
                                    ...
                                    AI discovers your ideal Telegram groups, posts value-first content, scrapes &amp; scores leads, then sends personalised 3-step DM sequences — all while you sleep.
                                </p>

                                {/* Feature list */}
                                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2.25rem', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                                    {[
                                        { icon: '🔍', label: 'AI Group Discovery', sub: 'Finds niche groups matching your ICP' },
                                        { icon: '📝', label: 'GPT-4o Content Engine', sub: 'Auto-posts unique content per group' },
                                        { icon: '⭐', label: 'Lead Scoring (0–100)', sub: '14-signal scoring on every scraped profile' },
                                        { icon: '💬', label: '3-Step DM Sequences', sub: 'Personalised outreach with smart timing' },
                                        { icon: '🛡️', label: 'Anti-Ban Safety System', sub: 'Human delays, flood-wait handling, rotation' },
                                    ].map(f => (
                                        <li key={f.label} style={{
                                            display: 'flex', alignItems: 'flex-start', gap: '0.75rem',
                                        }}>
                                            <span style={{ fontSize: '1.1rem', marginTop: '0.05rem', flexShrink: 0 }}>{f.icon}</span>
                                            <span>
                                                <span style={{ color: '#e2e8f0', fontWeight: 700, fontSize: '0.875rem' }}>{f.label}</span>
                                                <span style={{ color: '#475569', fontSize: '0.8rem', display: 'block', marginTop: '0.1rem' }}>{f.sub}</span>
                                            </span>
                                        </li>
                                    ))}
                                </ul>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.25rem' }}>
                                    ...
                                    <div style={{
                                        ...
                                        color: '#475569', fontSize: '0.72rem', fontFamily: 'monospace',
                                    }}>
                                        Telegram Growth Engine · Live
                                    </div>
                                    <span style={{
                                        display: 'inline-flex', alignItems: 'center', gap: '0.3rem',
                                        background: 'rgba(16,185,129,0.1)', color: '#10b981',
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.85rem', marginBottom: '1.25rem' }}>
                                    {[
                                        ...
                                        <div key={s.label} style={{
                                            ...
                                            <div style={{ color: '#94a3b8', fontSize: '0.72rem', fontWeight: 700, margin: '0.2rem 0' }}>{s.label}</div>
                                            <div style={{ color: '#10b981', fontSize: '0.68rem', fontWeight: 700 }}>{s.delta}</div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div style={{
                                    ...
                                    <div style={{ color: '#475569', fontSize: '0.7rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.75rem' }}>
                                        Live Feed
                                    </div>
                                    {[
                                        { t: '2m', e: '✅ Reply from @arjunm_biz · score 94 · hot lead' },
                                        { t: '8m', e: '📨 Step-2 DM sent to @saraht_growth' },
                                        { t: '15m', e: '👤 84 leads scraped from AI Founders India' },
                                        { t: '22m', e: '✏️ Post published · AI Founders India · 47 views' },
                                    ].map((item, i) => (
                                        <div key={i} style={{
                                            ...
                                            <span style={{ color: '#334155', fontSize: '0.68rem', flexShrink: 0, minWidth: '24px', paddingTop: '0.1rem' }}>{item.t}</span>
                                            <span style={{ color: '#64748b', fontSize: '0.75rem', lineHeight: 1.45 }}>{item.e}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
